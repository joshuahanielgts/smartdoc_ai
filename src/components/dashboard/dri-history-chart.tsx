...
export function DriHistoryChart({ history, container = 'card' }: DriHistoryChartProps) {
  const chartConfig = {
    dri: {
      label: 'DRI',
    ...
    return (
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            <div className="flex flex-row items-center justify-between pb-2">
                <div>
                <CardTitle className="text-foreground text-2xl font-semibold leading-none tracking-tight">DRI History</CardTitle>
                <CardDescription className="text-muted-foreground text-sm">Driver Risk Index over the current session</CardDescription>
                </div>
